"""
Django settings for CryptoStat project.
...
SECRET_KEY = 'django-insecure-zn%jx*5*tu(2fja8_-kihwyeu=mdpu(y%=2!n#-^3@7k=_i)^j'
...
WSGI_APPLICATION = 'CryptoStat.wsgi.application'
